                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" id="category_id" class="form-control @error('category_id') is_valid @enderror">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        <img src="{{asset('storage/' .$product->image)}}" width="100px" height="100px" style="margin-top: 15px;">
                                    </div>
                                </div>
                            </div><!-- end row -->
                            ...
                            <div class="row mb-5">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" cols="30" rows="10" class="form-control @error('image') is_invalid @enderror" placeholder="Describe your product...">{{$product->description}}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback">
                                                <strong>{{$message}}</strong>
                                            </span>
